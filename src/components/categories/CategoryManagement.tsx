...
export function CategoryManagement({
  ...
  async function remove(category: CategoryRow) {
    ...
    try {
      ...
      window.alert(
        reason instanceof Error ? reason.message : "Erro ao excluir categoria.",
      );
    }
  }
  return (
                  ...
                  <td>
                    <div className="table-actions flex gap-2">
                      ...
                      {category.usageCount > 0 ? (
                        <span
                          title="A categoria já está sendo utilizada"
                          className="inline-flex cursor-not-allowed"
                        >
                          <button
                            disabled
                            className="btn-secondary px-3 py-2 opacity-40"
                          >
                            <Trash2 size={16} />
                            Excluir
                          </button>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/45 p-4">
          <div className="card w-full max-w-md p-6">
            <div className="mb-5 flex items-center justify-between gap-4">
              <h2 className="text-xl font-black">Editar categoria</h2>
              <button
                type="button"
