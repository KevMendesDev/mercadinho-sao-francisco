...
O sistema SHALL informar separadamente falhas de permissão ou indisponibilidade da câmera e falhas de reconhecimento de código. O sistema SHALL oferecer um estado de processamento enquanto uma imagem selecionada estiver sendo analisada e SHALL permitir que o operador feche o leitor a qualquer momento.
